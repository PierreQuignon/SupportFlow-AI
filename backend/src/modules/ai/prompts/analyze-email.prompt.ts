export const buildAnalyzeEmailPrompt = (params: {
  fromName: string;
  fromEmail: string;
  subject: string;
  body: string;
}): string => `Tu es un assistant support client. Analyse cet email et retourne UNIQUEMENT un JSON valide, sans texte avant ou après.
